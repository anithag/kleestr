...
entry:
  ...
  store i8* getelementptr inbounds ([6 x i8]* @.str, i64 0, i64 0), i8** %dictionary, align 8, !dbg !129
...
entry:
  ...
  %a = alloca [10 x i8]
  %"alloca point" = bitcast i32 0 to i32
  %a1 = bitcast [10 x i8]* %a to i8*, !dbg !134
  call void @klee_make_symbolic(i8* %a1, i64 10, i8* getelementptr inbounds ([2 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !134
  %1 = getelementptr inbounds [10 x i8]* %a, i64 0, i64 9, !dbg !136
  %2 = load i8* %1, align 1, !dbg !136
  %3 = icmp eq i8 %2, 0, !dbg !136
  %4 = zext i1 %3 to i64, !dbg !136
  call void @klee_assume(i64 %4) nounwind, !dbg !136
  %a2 = bitcast [10 x i8]* %a to i8*, !dbg !137
  %5 = call i32 @prefix(i8* %a2) nounwind, !dbg !137
  store i32 %5, i32* %0, align 4, !dbg !137
  %6 = load i32* %0, align 4, !dbg !137
  store i32 %6, i32* %retval, align 4, !dbg !137
  %retval3 = load i32* %retval, !dbg !137
  ret i32 %retval3, !dbg !137
}
...
!0 = metadata !{i32 589870, i32 0, metadata !1, metadata !"prefix", metadata !"prefix", metadata !"prefix", metadata !1, i32 3, metadata !3, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, i32 (i8*)* @prefix} ; [ DW_TAG_subprogram ]
!1 = metadata !{i32 589865, metadata !"prefix.c", metadata !"/home/anitha/klee/examples/prefix/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"prefix.c", metadata !"/home/anitha/klee/examples/prefix/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i32 0} ; [ DW_TAG_compile_unit ]
...
!8 = metadata !{i32 589870, i32 0, metadata !1, metadata !"main", metadata !"main", metadata !"main", metadata !1, i32 18, metadata !9, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, i32 ()* @main} ; [ DW_TAG_subprogram ]
...
!127 = metadata !{i32 5, i32 0, metadata !128, null}
!128 = metadata !{i32 589835, metadata !0, i32 3, i32 0, metadata !1, i32 0} ; [ DW_TAG_lexical_block ]
!129 = metadata !{i32 6, i32 0, metadata !128, null}
!130 = metadata !{i32 8, i32 0, metadata !128, null}
!131 = metadata !{i32 11, i32 0, metadata !128, null}
!132 = metadata !{i32 7, i32 0, metadata !128, null}
!133 = metadata !{i32 14, i32 0, metadata !128, null}
!134 = metadata !{i32 20, i32 0, metadata !135, null}
!135 = metadata !{i32 589835, metadata !8, i32 18, i32 0, metadata !1, i32 1} ; [ DW_TAG_lexical_block ]
!136 = metadata !{i32 21, i32 0, metadata !135, null}
!137 = metadata !{i32 22, i32 0, metadata !135, null}
