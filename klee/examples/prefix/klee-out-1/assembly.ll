...
entry:
  ...
  store i8* getelementptr inbounds ([6 x i8]* @.str, i64 0, i64 0), i8** %dictionary, align 8, !dbg !127
  %1 = load i8** %dictionary, align 8, !dbg !129
  %2 = call i64 @strlen(i8* %1) nounwind readonly, !dbg !129
  %3 = trunc i64 %2 to i32, !dbg !129
  store i32 %3, i32* %len, align 4, !dbg !129
  %4 = load i32* %len, align 4, !dbg !130
  %5 = sext i32 %4 to i64, !dbg !130
  %6 = load i8** %x_addr, align 8, !dbg !130
  %7 = load i8** %dictionary, align 8, !dbg !130
  %8 = call i32 @strncmp(i8* %6, i8* %7, i64 %5) nounwind readonly, !dbg !130
  store i32 %8, i32* %0, align 4, !dbg !130
  %9 = load i32* %0, align 4, !dbg !130
  store i32 %9, i32* %retval, align 4, !dbg !130
  %retval1 = load i32* %retval, !dbg !130
  ret i32 %retval1, !dbg !130
}
...
entry:
  ...
  %a = alloca [10 x i8]
  %"alloca point" = bitcast i32 0 to i32
  %a1 = bitcast [10 x i8]* %a to i8*, !dbg !131
  call void @klee_make_symbolic(i8* %a1, i64 10, i8* getelementptr inbounds ([2 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !131
  %1 = getelementptr inbounds [10 x i8]* %a, i64 0, i64 9, !dbg !133
  %2 = load i8* %1, align 1, !dbg !133
  %3 = icmp eq i8 %2, 0, !dbg !133
  %4 = zext i1 %3 to i64, !dbg !133
  call void @klee_assume(i64 %4) nounwind, !dbg !133
  %a2 = bitcast [10 x i8]* %a to i8*, !dbg !134
  %5 = call i32 @prefix(i8* %a2) nounwind, !dbg !134
  store i32 %5, i32* %0, align 4, !dbg !134
  %6 = load i32* %0, align 4, !dbg !134
  store i32 %6, i32* %retval, align 4, !dbg !134
  %retval3 = load i32* %retval, !dbg !134
  ret i32 %retval3, !dbg !134
}
...
entry:
  %0 = icmp eq i64 %z, 0, !dbg !135
  br i1 %0, label %bb, label %return, !dbg !135
...
entry:
  ...
  %x1 = bitcast i32* %x to i8*, !dbg !139
  call void @klee_make_symbolic(i8* %x1, i64 4, i8* %name) nounwind, !dbg !139
  %0 = load i32* %x, align 4, !dbg !140
  ret i32 %0, !dbg !140
}

define void @klee_overshift_check(i64 %bitWidth, i64 %shift) nounwind {
entry:
  %0 = icmp ult i64 %shift, %bitWidth, !dbg !141
  br i1 %0, label %return, label %bb, !dbg !141
...
entry:
  %x = alloca i32, align 4
  %0 = icmp slt i32 %start, %end, !dbg !145
  br i1 %0, label %bb1, label %bb, !dbg !145

bb:                                               ; preds = %entry
  call void @klee_report_error(i8* getelementptr inbounds ([13 x i8]* @.str6, i64 0, i64 0), i32 17, i8* getelementptr inbounds ([14 x i8]* @.str17, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8]* @.str28, i64 0, i64 0)) noreturn nounwind, !dbg !146
  unreachable, !dbg !146

bb1:                                              ; preds = %entry
  %1 = add nsw i32 %start, 1, !dbg !147
  %2 = icmp eq i32 %1, %end, !dbg !147
  br i1 %2, label %bb8, label %bb3, !dbg !147

bb3:                                              ; preds = %bb1
  %x4 = bitcast i32* %x to i8*, !dbg !148
  call void @klee_make_symbolic(i8* %x4, i64 4, i8* %name) nounwind, !dbg !148
  %3 = icmp eq i32 %start, 0, !dbg !149
  %4 = load i32* %x, align 4, !dbg !150
  br i1 %3, label %bb5, label %bb6, !dbg !149

bb5:                                              ; preds = %bb3
  %5 = icmp ult i32 %4, %end, !dbg !150
  %6 = zext i1 %5 to i64, !dbg !150
  call void @klee_assume(i64 %6) nounwind, !dbg !150
  br label %bb7, !dbg !150

bb6:                                              ; preds = %bb3
  %7 = icmp sge i32 %4, %start, !dbg !151
  %8 = zext i1 %7 to i64, !dbg !151
  call void @klee_assume(i64 %8) nounwind, !dbg !151
  %9 = load i32* %x, align 4, !dbg !152
  %10 = icmp slt i32 %9, %end, !dbg !152
  %11 = zext i1 %10 to i64, !dbg !152
  call void @klee_assume(i64 %11) nounwind, !dbg !152
  br label %bb7, !dbg !152

bb7:                                              ; preds = %bb6, %bb5
  %12 = load i32* %x, align 4, !dbg !153
  br label %bb8, !dbg !153
...
entry:
  %0 = icmp eq i64 %len, 0, !dbg !155
  br i1 %0, label %bb2, label %bb, !dbg !155
...
bb:                                               ; preds = %bb, %entry
  ...
  %1 = load i8* %src.06, align 1, !dbg !156
  store i8 %1, i8* %dest.05, align 1, !dbg !156
  %indvar.next = add i64 %indvar, 1
  %exitcond1 = icmp eq i64 %indvar.next, %len
  br i1 %exitcond1, label %bb1.bb2_crit_edge, label %bb, !dbg !155
...
!8 = metadata !{i32 589870, i32 0, metadata !1, metadata !"main", metadata !"main", metadata !"main", metadata !1, i32 13, metadata !9, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, i32 ()* @main} ; [ DW_TAG_subprogram ]
...
!127 = metadata !{i32 6, i32 0, metadata !128, null}
!128 = metadata !{i32 589835, metadata !0, i32 4, i32 0, metadata !1, i32 0} ; [ DW_TAG_lexical_block ]
!129 = metadata !{i32 7, i32 0, metadata !128, null}
!130 = metadata !{i32 9, i32 0, metadata !128, null}
!131 = metadata !{i32 15, i32 0, metadata !132, null}
!132 = metadata !{i32 589835, metadata !8, i32 13, i32 0, metadata !1, i32 1} ; [ DW_TAG_lexical_block ]
!133 = metadata !{i32 16, i32 0, metadata !132, null}
!134 = metadata !{i32 17, i32 0, metadata !132, null}
!135 = metadata !{i32 13, i32 0, metadata !136, null}
!136 = metadata !{i32 589835, metadata !11, i32 12, i32 0, metadata !12, i32 0} ; [ DW_TAG_lexical_block ]
!137 = metadata !{i32 14, i32 0, metadata !136, null}
!138 = metadata !{i32 15, i32 0, metadata !136, null}
!139 = metadata !{i32 15, i32 0, metadata !81, null}
!140 = metadata !{i32 16, i32 0, metadata !81, null}
!141 = metadata !{i32 21, i32 0, metadata !142, null}
!142 = metadata !{i32 589835, metadata !26, i32 20, i32 0, metadata !27, i32 0} ; [ DW_TAG_lexical_block ]
!143 = metadata !{i32 27, i32 0, metadata !142, null}
!144 = metadata !{i32 29, i32 0, metadata !142, null}
!145 = metadata !{i32 16, i32 0, metadata !88, null}
!146 = metadata !{i32 17, i32 0, metadata !88, null}
!147 = metadata !{i32 19, i32 0, metadata !88, null}
!148 = metadata !{i32 22, i32 0, metadata !88, null}
!149 = metadata !{i32 25, i32 0, metadata !88, null}
!150 = metadata !{i32 26, i32 0, metadata !88, null}
!151 = metadata !{i32 28, i32 0, metadata !88, null}
!152 = metadata !{i32 29, i32 0, metadata !88, null}
!153 = metadata !{i32 32, i32 0, metadata !88, null}
!154 = metadata !{i32 20, i32 0, metadata !88, null}
!155 = metadata !{i32 15, i32 0, metadata !113, null}
!156 = metadata !{i32 16, i32 0, metadata !113, null}
!157 = metadata !{i32 17, i32 0, metadata !113, null}
