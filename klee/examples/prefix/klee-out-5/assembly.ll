...
@.str2 = private unnamed_addr constant [12 x i8] c"a[0] == 'h'\00", align 1
...
entry:
  ...
  %5 = getelementptr inbounds [10 x i8]* %a, i64 0, i64 0, !dbg !547
  %6 = load i8* %5, align 1, !dbg !547
  %7 = icmp ne i8 %6, 104, !dbg !547
...
entry:
  ...
  store i8* %s2, i8** %s2_addr
  store i64 %n, i64* %n_addr
  %1 = load i8** %s1_addr, align 8, !dbg !637
  store i8* %1, i8** %r1, align 8, !dbg !637
  %2 = load i8** %s2_addr, align 8, !dbg !639
  store i8* %2, i8** %r2, align 8, !dbg !639
  br label %bb1, !dbg !639

bb:                                               ; preds = %bb1
  %3 = load i8** %r2, align 8, !dbg !640
  %4 = load i8* %3, align 1, !dbg !640
  %5 = load i8** %r1, align 8, !dbg !640
  store i8 %4, i8* %5, align 1, !dbg !640
  %6 = load i8** %r1, align 8, !dbg !640
  %7 = getelementptr inbounds i8* %6, i64 1, !dbg !640
  store i8* %7, i8** %r1, align 8, !dbg !640
  %8 = load i8** %r2, align 8, !dbg !640
  %9 = getelementptr inbounds i8* %8, i64 1, !dbg !640
  store i8* %9, i8** %r2, align 8, !dbg !640
  %10 = load i64* %n_addr, align 8, !dbg !641
  %11 = sub i64 %10, 1, !dbg !641
  store i64 %11, i64* %n_addr, align 8, !dbg !641
  br label %bb1, !dbg !641

bb1:                                              ; preds = %bb, %entry
  %12 = load i64* %n_addr, align 8, !dbg !642
  %13 = icmp ne i64 %12, 0, !dbg !642
  br i1 %13, label %bb, label %bb2, !dbg !642

bb2:                                              ; preds = %bb1
  %14 = load i8** %s1_addr, align 8, !dbg !643
  store i8* %14, i8** %0, align 8, !dbg !643
  %15 = load i8** %0, align 8, !dbg !643
  store i8* %15, i8** %retval, align 8, !dbg !643
  %retval3 = load i8** %retval, !dbg !643
  ret i8* %retval3, !dbg !643
}
...
entry:
  ...
  store i64 %n, i64* %n_addr
  %1 = load i8** %s_addr, align 8, !dbg !644
  store i8* %1, i8** %p, align 8, !dbg !644
  br label %bb1, !dbg !644

bb:                                               ; preds = %bb1
  %2 = load i32* %c_addr, align 4, !dbg !646
  %3 = trunc i32 %2 to i8, !dbg !646
  %4 = load i8** %p, align 8, !dbg !646
  store i8 %3, i8* %4, align 1, !dbg !646
  %5 = load i8** %p, align 8, !dbg !646
  %6 = getelementptr inbounds i8* %5, i64 1, !dbg !646
  store i8* %6, i8** %p, align 8, !dbg !646
  %7 = load i64* %n_addr, align 8, !dbg !647
  %8 = sub i64 %7, 1, !dbg !647
  store i64 %8, i64* %n_addr, align 8, !dbg !647
  br label %bb1, !dbg !647

bb1:                                              ; preds = %bb, %entry
  %9 = load i64* %n_addr, align 8, !dbg !648
  %10 = icmp ne i64 %9, 0, !dbg !648
  br i1 %10, label %bb, label %bb2, !dbg !648

bb2:                                              ; preds = %bb1
  %11 = load i8** %s_addr, align 8, !dbg !649
  store i8* %11, i8** %0, align 8, !dbg !649
  %12 = load i8** %0, align 8, !dbg !649
  store i8* %12, i8** %retval, align 8, !dbg !649
...
!637 = metadata !{i32 20, i32 0, metadata !638, null}
!638 = metadata !{i32 589835, metadata !94, i32 19, i32 0, metadata !95, i32 0} ; [ DW_TAG_lexical_block ]
!639 = metadata !{i32 21, i32 0, metadata !638, null}
!640 = metadata !{i32 29, i32 0, metadata !638, null}
!641 = metadata !{i32 30, i32 0, metadata !638, null}
!642 = metadata !{i32 28, i32 0, metadata !638, null}
!643 = metadata !{i32 34, i32 0, metadata !638, null}
!644 = metadata !{i32 19, i32 0, metadata !645, null}
!645 = metadata !{i32 589835, metadata !103, i32 18, i32 0, metadata !104, i32 0} ; [ DW_TAG_lexical_block ]
!646 = metadata !{i32 28, i32 0, metadata !645, null}
!647 = metadata !{i32 29, i32 0, metadata !645, null}
!648 = metadata !{i32 27, i32 0, metadata !645, null}
!649 = metadata !{i32 32, i32 0, metadata !645, null}
